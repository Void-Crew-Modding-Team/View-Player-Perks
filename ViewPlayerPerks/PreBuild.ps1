...
$ProjectReadmeFileOutPath2 = "Null"
...
elseif($ProjectReadmeFileOutPath -eq "BothDir")
{
    $ProjectReadmeFileOutPath = "$SolutionDir\README.md"
    $ProjectReadmeFileOutPath2 = "$PSScriptRoot\README.md"
}
...
# Write README to Solution Directory Too
if ($ProjectReadmeFileOutPath2 -ne "Null")
{
    [System.IO.File]::WriteAllLines($ProjectReadmeFileOutPath2, $ReadmeData, $Utf8NoBomEncoding)
}
